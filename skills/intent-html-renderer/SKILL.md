...
10. Browser-check desktop and mobile when possible. Use `references/visual-quality-checklist.md` for final review. If browser tooling, ports, or screenshots are blocked, use build/type/validator evidence and explicitly report the missing visual proof.
